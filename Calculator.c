    ...
    switch(choice){
        ...
        case 2:{
            ...
            if(a==0){
                ...
                int complex_roots=0;
                double x1,x2;
                quadratic_equation(a,b,c,&x1,&x2,&complex_roots);
                if(complex_roots){
                    printf("\n\n\t\t\t\tThe equation have complex roots.\n");
                }
                else{
                    printf("\n\n\t\t\t\tx1 = %.2lf and x2 = %.2lf\n",x1,x2);
...
void quadratic_equation(double a, double b, double c, double *x1,double *x2,int *complex_roots){
